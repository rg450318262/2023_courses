...
# leaflet::leaflet() %>%
#   addTiles() %>%
#   addMarkers(lng=18.9553, lat=69.6942)
```
...
```{r}
#| layout-ncol: 2
#| tbl-cap: "KMO test of sampling adequacy for with-leader group (long)"
#| tbl-subcap: ["(a)Full items", "(b)Excluding two items"]
library(psych)
library(knitr)
...
names(KMO.ldr20) [KMO.ldr20 |> length()] <- "Overall"
